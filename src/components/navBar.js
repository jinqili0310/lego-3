 ...
 * @LastEditTime: 2020-12-01 02:50:17
 * @FilePath: /lego-3/src/components/navBar.js
 */
import React, { Component } from 'react';
import '../App.css';
import 'bootstrap/dist/css/bootstrap.min.css';
import { Navbar, Nav, Form } from 'react-bootstrap';
import icon from '../assets/images/LEGO-Logo-Ani2b.gif';
	...
	render() {
		return (
			<Navbar className="nav-style" collapseOnSelect expand="lg" fixed="top">
				<Navbar.Brand href="/lego-3/#/" className="nav-brand">
					<img alt="" src={icon} className="nav-icon" />
				</Navbar.Brand>
				<Nav className="nav-link-group">
					<span className="nav-link">LEGO</span>
				</Nav>
				{/* <Nav className="nav-link-group">
					<Nav.Link
						href="/shop"
